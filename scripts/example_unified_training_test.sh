...
export llm_path="/workspace/models/Qwen2.5-0.5B-Instruct"
export vae_path="/workspace/models/flux/ae.safetensors"
export vit_path="/workspace/models/siglip-so400m-14-980-flash-attn2-navit"
